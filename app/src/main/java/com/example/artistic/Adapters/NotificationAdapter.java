...
import com.example.artistic.Models.Notifications;
import com.example.artistic.Models.Posts;
import com.example.artistic.OthersProfileActivity;
import com.example.artistic.PostDetailsActivity;
...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        getUserInfo(holder.profile,holder.fullname,notifications.getUserid());
